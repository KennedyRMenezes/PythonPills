...
class Book(Media):
    ...
    def __init__(self, title: str, autor: str, publication_year: str, page_num: int, isbn: str, publisher: str):
    ...
    def consults(self):
        result = ""
        print(f"User that have consulted {self.title}")
...
class Revista(Media):
    ...
    def __init__(self, title: str, autor: str, publication_year: str, edition_num: int, periodicy: int, publisher: str):
        super().__init__(title, autor, publication_year)
...
class Filme(Media):
    ...
    def __init__(self, title: str, autor: str, publication_year: str, duration: int, genre: str):
        super().__init__(title, autor, publication_year)
